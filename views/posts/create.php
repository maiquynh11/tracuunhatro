...
<div class="container-fluid pt-3">
   <?php if ($model):?>
        <div class="row">
            <div class="col-md-2 sidebar-user pl-0 pr-0">
                <div class="avatar">
            ...
            <div class="col-md-10 create-post ">
                <!-- <p class="text-titles">TẠO BÀI ĐĂNG</p> -->
                <div class="">
                    <p class="text-titles mt-2">KHU VỰC</p>
                    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'], ]); ?>
                        <?= $form->field($model, 'dmkhuvuc_id')->dropDownList(
                                    ArrayHelper::map(Dmkhuvuc::find()->all(), 'id', 'khuvuc')
                                )->label(false)?>
                                 <?php ActiveForm::end(); ?>
                    <p class="text-titles mt-2">DIỆN TÍCH</p>
                    <?= $form->field($model, 'dientich')->textInput(['maxlength' => true])->label(false) ?>
    
                    <p class="text-titles mt-2">MỨC GIÁ CHO THUÊ</p>
                    <?= $form->field($model, 'gia')->textInput()->label(false) ?>
    
                </div>
                <div class="create-img">
                    <p class="text-titles mt-2">HÌNH ẢNH</p>
                </div>
                <div class="create-contact">
                    <p class="text-titles mt-2">THÔNG TIN LIÊN HỆ</p>
                    <input type="text" class="form-control" id="phone" placeholder="">
                </div>
                <div class="create-ulility">
                    <p class="text-titles mt-2">ĐỐI TƯỢNG SỬ DỤNG</p>   
                ...
                <div class="create-ulility">
                    <p class="text-titles mt-2">TIỆN ÍCH</p>
                ...
                <div class="create-infor">
                    <p class="text-titles mt-2">MÔ TẢ</p>
